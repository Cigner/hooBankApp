...
const FeatureCard = ({icon, title, content, index}) => (
    <div className={`flex flex-row w-full p-6 rounded-[20px] ${index !== features.length -1 ? "mb-6" : "mb-0"} feature-card`}>
...
const Business = () => {
    return (
        <section id="features" className={`${layout.section} sm:px-0 px-2`}>
